  ...
  <div>
    ...
    <div class="contnet">
        ...
        <el-row :gutter="0" v-for="(announcement,index) in announcements" :key="announcement.id" :class="{active:index%2==0}" class="content-val">
            ...
            <el-col :span="8"><div class="text" style="color:#298cf1;font-size:16px;cursor:pointer" @click="goDetail(announcement.user.username)">{{announcement.user.username}}</div></el-col>
